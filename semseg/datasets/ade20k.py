...
class ADE20K(Dataset):
    CLASSES = ["background", "3point_Region", "freethrow_circle", "2point_region"] #red, blue, green, yellow
    # CLASSES = ["Background","Audience","Goal","Outside","Panelty","Small"]
    # CLASSES = [
    ...
    # ]
    # PALETTE = torch.tensor([[165,42,42], [0,0,255], [0,255,0], [255,0,0], [255,255,0],[0,0,0]])
    PALETTE = torch.tensor([[165,42,42], [0,0,255], [0,255,0], [255,0,0]])
